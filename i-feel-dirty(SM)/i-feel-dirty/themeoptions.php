...
class ThemeOptions {
	...
	function ThemeOptions() {
		...
		setThemeOptionDefault('double_sidebars', true);
		setThemeOptionDefault('show_archive', true);
		setThemeOptionDefault('show_contact', true);
		setThemeOptionDefault('show_exif', true);
		setThemeOptionDefault('show_random_pict', true);
		setThemeOptionDefault('show_tag_cloud', true);
		setThemeOptionDefault('use_colorbox_image', true);
	...
	function getOptionsSupported() {
		return array(
			gettext('Double Sidebars') => array('key' => 'double_sidebars', 'type' => OPTION_TYPE_CHECKBOX, 'desc' => gettext("Check to enable additional sidebar to the left")."<p class='notebox'>".gettext("<strong>Note:</strong> The option of which items to place on either left and right sidebars is still been developed!")."</p>"),
